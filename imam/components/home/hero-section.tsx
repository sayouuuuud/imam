            ...
            <div className="flex items-center justify-center gap-3 text-center">
              ...
              {heroData.notice_link ? (
                <Link
                  ...
                  className="text-base font-medium text-foreground dark:text-white hover:underline"
                >
                  {heroData.notice_text}
                </Link>
              ) : (
                <span className="text-base font-medium text-foreground dark:text-white">{heroData.notice_text}</span>
              )}
            </div>
          </div>
        </div>
