    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background h-16 px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="hidden md:flex items-center gap-2 bg-muted rounded-lg px-3 py-2 border border-border">
          <span className="material-icons-outlined text-text-muted text-lg">
            search
          </span>
          <input
            type="text"
            placeholder="بحث..."
            className="bg-transparent border-none outline-none text-sm w-40 text-foreground placeholder:text-text-muted"
          />
        </div>
        <ThemeToggle />
        <NotificationBell />
