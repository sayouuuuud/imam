...
important_notice: data[0].important_notice || contactSettings.important_notice,
          ...
          subject_options: data[0].subject_options || contactSettings.subject_options,
        })
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("[CONTACT] Sending message:", formData)
      const supabase = createClient()
...
onChange = {(e) => setFormData({ ...formData, subject: e.target.value })}
                ...
                >
                  ...
                  {contactSettings.subject_options?.map((subject, index) => (
                    <option key={index}
value = {subject}>
                      {subject}
                    </option>
