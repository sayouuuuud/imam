...
<h1 className="text-3xl font-bold text-foreground dark:text-white">إعدادات صفحة التواصل</h1>
</div>
          <p className="text-text-muted">تخصيص التنويه الهام ومعلومات التواصل</p>
</div>
      </div>
...
<h3 className="text-lg font-bold text-foreground dark:text-white">التنويه الهام</h3>
</div>
        <p className="text-sm text-text-muted">هذا التنويه يظهر في صفحة التواصل للزوار</p>
<div className="flex items-center justify-between p-4 bg-muted/50 rounded-xl">
          <div>
<Label className="text-base">تفعيل التنويه</Label>
<p className="text-sm text-text-muted">إظهار أو إخفاء التنويه الهام</p>
</div>
          <Switch
            checked={settings.notice_enabled}
onCheckedChange = {(checked) => setSettings({ ...settings,
...
<h3 className="text-lg font-bold text-foreground dark:text-white">مواضيع الرسائل</h3>
</div>
        <p className="text-sm text-text-muted">المواضيع المتاحة في قائمة الموضوع</p>
...
className="w-full"
      ...
      <div className="bg-card rounded-2xl border border-border p-6 space-y-6">
<h3 className="text-lg font-bold text-foreground dark:text-white">معلومات التواصل</h3>
