...
// ملاحظة: الـ loading state محتاج خلفية صلبة hex color عشان تشتغل
// في المتصفحات الداخلية اللي بتتجاهل CSS @layer والـ variables
const PDFViewer = dynamic(() => import("@/components/pdf-viewer").then(mod => mod.PDFViewer), {
    ssr: false,
    loading: () => (
        <div className="h-full w-full flex items-center justify-center rounded-lg" style={{ backgroundColor: '#f8fafc' }}>
